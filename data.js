    ...
    uricAcidEtiology: {
      ...
      rows: [
        ...
        [{ en: "University → grad school", zh: "大學 → 研究所" }, "18–24",
          { en: "Daily half-sugar bubble tea (~32g sugar / ~16g fructose) × 6 yr", zh: "每日半糖珍奶（約 32g 糖 / 16g 果糖）× 6 年" },
          { en: "First lab: 26 yr UA 7.8 (2015). Already supra-threshold; metabolic syndrome onset.", zh: "首筆抽血：26 歲 UA 7.8（2015）。已超標；代謝症候群啟動。" }],
