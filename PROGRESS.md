...
*最後更新：2026-07-08（⭐ **新增〇、健康哲學 North Star — 三本柱（吃・動・睡）+ 補品是助攻**；起於 glycine 3g 睡眠實驗體悟；補品定位守序、自律神經為睡眠第四柱）*
*前次更新：2026-06-29（⭐ **OSA/缺氧假設撤回** — 醫院指尖透射式連續血氧整夜平穩、無掉氧，證實 Garmin 腕式 SpO2 掉氧大半為 artifact；淺眠主因重定向為夜間認知喚醒（看美股）+ 自律神經；鎂 100mg 主觀有效；白天精力回升。睡眠努力由 50% 下修並改為「行為性」而非 CPAP/設備。詳見 `articles/osa-sleep/2026-06-29-spo2-fingertip-oximetry-correction.md`）*
...
## 〇、健康哲學（North Star）：三本柱 — 吃・動・睡

*建立 2026-07-08，起於 glycine 3g 睡眠實驗的體悟。此節是整套系統的「為什麼」；當你迷失在數字裡，回這裡看一眼，記得當初為什麼激動。*

> **最普遍、最基礎的三件事——吃飯、睡覺、運動——才是避免生病、對抗生老病死最需要下功夫的地方。補給品是助攻，不是地基。**

**核心信念（有大型證據支撐，非雞湯）**：世代研究顯示，把幾件基本事做好（不菸、規律運動、健康飲食、健康體重、睡得好）可多出約 **10–14 年**不帶重大慢性病的壽命；**三到五成癌症**可歸因於可改變的生活型態。我們能主動施力的，是**機率**——而機率正是唯一值得下功夫的地方。

### 三本柱的具體要求

| 柱 | 主攻（行為，佔 ~90%） | 助攻（補品，補洞用，~5–10%） |
|----|----------------------|------------------------------|
| **吃（飲食）** | 低鈉、高鉀、高纖、足量蛋白；味覺 set-point 已重設（不嗜甜鹹） | 三餐不足時：whey（蛋白缺口）、魚油（TG/發炎，勿期待奇蹟）、D3（**驗了 25-OH-D 才補**） |
| **動（運動）** | 每週足量有氧 + 1–2 次阻力訓練 | **有訓練才有意義**：creatine 5g（五者中證據最強）、whey（恢復） |
| **睡（睡眠）** | 每天充足深睡；睡前關掉「盯盤的腦」 | glycine 3g（降核心體溫、拉進深睡）、鎂 100mg |

### 三本柱不是三個獨立的箱子，是一個互相加乘的循環

睡不好 → 隔天飢餓素↑、飽足素↓ → 想吃高糖高鹽 → 飲食柱垮、運動恢復差、胰島素阻抗↑。**動一個，另兩個變容易；放掉一個，另兩個一起爛。睡眠是地基。**

### ⭐ 安靜的第四柱：壓力／自律神經

「睡覺」這根柱子的根，其實長在自律神經上。**個人案例**：夜間淺眠主因是行為性／認知性交感亢奮（睡前看美股 21:30–04:00），**不是缺營養素**。glycine 是助攻，真正的主攻是把睡前那顆盯盤的腦關掉。（呼應 2026-06-29 OSA/缺氧假設撤回 — 問題在行為與自律神經，不在設備）

### 補品的定位——守住順序（最容易被熱情倒過來的一點）

**行為（吃動睡）是地基，佔 90%；補品是最後 5–10% 的補洞工具，永遠不是主角。** 補品清單越完整，越要記得它們是「補」——補地基的縫隙，不是地基本身。找到 glycine 這種讓人驚艷的補品時，更要小心別讓興奮把順序顛倒。飲食柱裡「低鈉高鉀高纖」本身對 BP/UA 的貢獻，大過任何一顆藥丸。

### 誠實校準

做好這三（四）件事，能**大幅改變機率、把人生末端的「生病期」壓縮到最短**（醫學上叫 compression of morbidity）——但**不是保證**，基因與運氣仍在牌桌上。價值是雙重的：**既降低生病機率，也讓萬一真的生病時，身體更有本錢扛過去、恢復得更好。** 不是「不會死」，是「活得久、活得好，最後走得乾脆」。

*註：本節與 `articles/2026-03-25-supplement-guide.md` 互為表裡——那裡是「補什麼、劑量時機」，這裡是「為什麼補品只是助攻」。*
