...
window.HC_DATA = {
  ...
  tracker: {
    ...
    // daily weight (kg)
    weight: [67.9, 67.3, 67.6, 68.7, 68.6, 68.3, 68, 67.6, 67.3, 67.3, 68, 68.2, 67.6, 66.8],
    // Garmin Sleep Score
    sleep:  [67, 74, 74, 65, 64, 65, 74, 80, 49, 80, 65, 70, 75, 66],
    // Body Battery waking
    bb:     [34, 51, 63, 48, 62, 54, 61, 56, 34, 59, 55, 53, 64, 55],
