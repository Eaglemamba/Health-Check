...
window.HC_DATA = {
    ...
    uphillWalk: {
      ...
      prescription: {
        ...
        rows: [
          ...
          ["4.8 km/h", "12%", "8.0", "148-160", { en: "Z3 (only when well-recovered)", zh: "Z3（僅恢復良好時）" }],
        ],
        anchor: {
      ...
      safety: {
        ...
        items: {
          en: [
            ...
            "Poor sleep last night (Sleep Score < 65 or Body Battery < 40) → Z1 only today (no incline) — save recovery.",
            "Morning BP > 140/90 → defer session or downgrade to Z1.",
            "Build to 12-3-30 (12% × 3 mph) gradually — HR 150+ is taxing on a low aerobic base; progress only when recovery markers are good.",
          ...
          zh: [
            ...
            "昨夜睡眠差（Sleep Score < 65 或 Body Battery < 40）→ 當日只走 Z1（不爬坡），保留恢復。",
            "晨間 BP > 140/90 → 當日延後或改 Z1。",
            "12-3-30（12% × 3 mph）循序漸進 — HR 150+ 對低有氧基礎負擔大，恢復指標良好才進階。",
  ...
  suppsDetail: {
    fullStack: {
      ...
      pending: [
        { item: "NAC 600mg × 2 (RETIRED 6/29 — was conditional on OSA confirmation)",
          dose: "1200 mg/day", reason: { en: "Rationale was OSA-driven (Sadasivam 2011 AHI 27→3). OSA/hypoxia ruled out 6/29 → no longer indicated for sleep. Prior self-trial subjective null. Drop unless a separate (non-OSA) indication arises.", zh: "原理據為 OSA 驅動（Sadasivam 2011 AHI 27→3）。OSA/缺氧已於 6/29 排除 → 睡眠用途不再成立。前次自試無感。除非有其他（非 OSA）適應症，否則停用。" }, cost: "250–400" },
    ...
    hourly: {
      ...
      rows: [
        ...
        ["~9:30", { en: "Matcha (office) 🆕 2026-05-14", zh: "抹茶（辦公室）🆕 2026-05-14" }, "300 mL",
          { en: "Matcha 3–4g + 300 mL warm water (≤80°C). EGCG ~75–120 mg + L-theanine. Caffeine ~90–120 mg → 22:00 residual ~16–20 mg (low evening caffeine level).",
            zh: "抹茶 3–4g + 溫水 300 mL（≤80°C）。EGCG ~75–120 mg + L-theanine。咖啡因 ~90–120 mg → 22:00 殘餘 ~16–20 mg（晚間咖啡因殘餘低）。" }],
        ...
        ["21:00", { en: "Bedtime stack (tri-axis sleep onset)", zh: "睡前 stack（三軸入睡）" }, { en: "150 mL room-temp water for glycine", zh: "150 mL 室溫水沖 Glycine" },
          { en: "Mg glycinate 300mg elemental (Doctor's Best 100mg/tablet → 3 tablets, or powder) (GABA brake + BP + vit-D cofactor) + Tart cherry 500-2000mg (melatonin axis) + Glycine pure powder 3g 🆕 (SCN core-temp drop + NMDA + brainstem) + Fish oil ×2 (second half). Humidifier 50-60% RH + AC ≥26°C + saline rinse (nasal comfort / sleep hygiene — OSA bridge framing retired 6/29).",
            zh: "鎂甘胺酸 元素鎂 300mg（Doctor's Best 每錠 100mg → 3 錠，或改粉劑）（GABA 煞車 + BP + 維D 輔因子）+ 酸櫻桃 500-2000mg（melatonin 軸）+ Glycine 純粉 3g 🆕（SCN 核心降溫 + NMDA + 腦幹 三軸）+ 魚油 ×2（後半）。加濕器 50-60% RH + 冷氣 ≥26°C + 鹽水洗鼻（鼻腔舒適／睡眠衛生 — OSA 橋接框架 6/29 退役）。" }],
        ...
        ["21:17", { en: "In bed — tennis ball T-shirt + side sleep + wedge", zh: "上床 — 網球 T-shirt + 側睡 + 楔形枕" }, "—",
          { en: "Side sleep + wedge pillow 15° optional for comfort/reflux. NO phone in bed (key behavioral anchor). ❌ Tennis-ball anti-supine / POSA rationale RETIRED 6/29 — no confirmed OSA; positional therapy no longer indicated.",
            zh: "側睡 + 楔形枕 15° 可選（舒適／逆流）。床上不滑手機（關鍵行為錨點）。❌ 網球防仰睡／POSA 理據 6/29 退役 — 無確診 OSA，體位治療不再適用。" }],
    ...
    summary: {
      ...
      items: {
        en: [
          ...
          "❌ Retired 6/29: NAC 600mg × 2 (was OSA-conditional; OSA ruled out)",
        ],
        zh: [
          ...
          "❌ 6/29 退役：NAC 600mg × 2（原 OSA 條件性；OSA 已排除）",
        ],
      },
      extras: {
        en: [
  ...
  safetyDetail: {
    ...
    medicalVisits: {
      ...
      rows: [
        [{ en: "Sleep clinic — only if behavioral repair fails (full PSG for UARS/PLMD)", zh: "睡眠門診 — 僅在行為修復無效時（全套 PSG 排 UARS/PLMD）" }, { en: "Hospital with sleep center", zh: "有睡眠中心的醫院" }, { en: "Deferred — try behavioral first (OSA ruled out 6/29)", zh: "暫緩 — 先行為調整（OSA 已排除 6/29）" }],
  ...
  interventions: [
    ...
    { date: "2026-05-13",
      en: "Wedge pillow 15° + side sleep (POSA trial — rationale retired 6/29)",
      zh: "楔形枕 15° + 側睡（POSA 試驗 — 理據 6/29 退役）",
      detail: { en: "[Historical] Tennis-ball / POSA rationale RETIRED 6/29 — OSA ruled out by fingertip oximetry. Side sleep + wedge kept only for comfort/reflux.",
                zh: "[歷史] 網球／POSA 理據 6/29 退役 — 指尖血氧排除 OSA。側睡 + 楔形枕僅留作舒適／逆流用。" },
