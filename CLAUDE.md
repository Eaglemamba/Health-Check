...
- **核心目標**：降 UA、降 LDL、降 BP 週均、**睡眠品質（行為性）**、**體組成 Recomp**（軀幹脂肪降至標準區 + 維持 LBM ≥54kg；體重持平 65–66.5 band，不主動破 65 — 體重框架已於 2026-06-16 退役，詳見 PROGRESS.md §三）
- **⚠️ OSA / 夜間缺氧假設已撤回（2026-06-29）**：指夾式（透射式）連續血氧整夜平穩、無掉氧 → Garmin 腕式 SpO2 掉氧證實為動作 artifact。**勿再以「缺氧 / OSA / CPAP / 設備」框架分析睡眠**；淺眠重定向為夜間認知/行為性喚醒（看美股）+ 自律神經，介入走行為路徑。殘餘未排除者僅「不掉血氧」的 UARS / PLMD，須行為調整後仍明顯淺眠再考慮含 EEG+EMG 全套 PSG。詳見 `articles/osa-sleep/2026-06-29-spo2-fingertip-oximetry-correction.md`
