...
window.HC_DATA = {
  ...
  hero: {
    ...
    progressMeta: { en: "Day 61 · 67.6 kg · Sat official (5/16)", zh: "第 61 天 · 67.6 公斤 · 週六正式（5/16）" },
    startDate: { en: "Start date · Mar 17, 2026 · Last sync 5/16", zh: "起始日期 · 2026 年 3 月 17 日 · 最後同步 5/16" },
    startWeight: 70,
    targetWeight: 65,
    currentWeight: 67.6,
  ...
  markers: [
    {
      ...
      delta: { en: "W19 weekly avg (4 days) · target met (<130) · last 115/68 (5/16)", zh: "W19 週均（4 天）· 已達標 (<130) · 最新 115/68 (5/16)" },
  ...
  diet: {
    ...
    beverage: {
      ...
      head: { en: ["Time", "Drink", "Metabolic target"],
              zh: ["時間", "飲料", "代謝目標"] },
      rows: [
        [{ en: "Breakfast 07:00 (home) 🆕", zh: "早餐 07:00（家）🆕" },
          { en: "Snow Factory No.6 yogurt 150cc + low-fat milk 100cc + ON whey + oats 20g + chia 5g + L-citrulline 4g + D3K2", zh: "雪坊 6 號優格 150cc + 低脂奶 100cc + ON 乳清 + 燕麥 20g + 奇亞籽 5g + 瓜胺酸 4g + D3K2" },
          { en: "Casein+whey (UA clearance) + β-glucan + NO precursor + ω-3 ALA + fat-soluble vitamin window", zh: "酪蛋白+乳清（尿酸排泄）+ β-葡聚醣 + NO 前體 + ω-3 ALA + 脂溶性維生素吸收窗" }],
  ...
  tracker: {
    ...
    bp: [
      [113,68], [113,68], [113,68], [113,68], [128,78], [120,73], [131,79], [123,76], [126,74], [131,75], [114,66], [125,70], [122,69], [115,68],
    ],
    // 4/21–5/4 daily weight (kg)
    weight: [67.8, 68.7, 69.1, 68.4, 68.2, 68.2, 68.1, 68, 68.7, 68.5, 68.3, 67.9, 67.3, 67.6],
    // Garmin Sleep Score
    sleep:  [69, 77, 77, 71, 75, 68, 78, 78, 79, 44, 67, 67, 74, 74],
    // Body Battery waking
    bb:     [41, 54, 49, 47, 56, 47, 37, 48, 55, 36, 42, 34, 51, 63],
  ...
  routineDetail: {
    hourly: {
      ...
      rows: [
        ...
        ["7:00", { en: "Breakfast (home) — yogurt blend 🆕 2026-05-14", zh: "早餐（家）— 優格飲 🆕 2026-05-14" }, "—",
          { en: "Snow Factory No.6 yogurt 150cc + low-fat milk 100cc + ON whey 1 scoop + barley/oats 20g + chia 5g + D3 3000 IU + K2 MK-7 180mcg + L-citrulline 4g + probiotic. NO matcha (relocated to office 9:30). Casein+whey (UA), β-glucan, ω-3 ALA.",
            zh: "雪坊 6 號優格 150cc + 低脂奶 100cc + ON 乳清 1 份 + 大麥燕麥 20g + 奇亞籽 5g + D3 3000 IU + K2 MK-7 180mcg + 瓜胺酸 4g + 益生菌。不放抹茶（移至辦公室 9:30）。酪蛋白+乳清（尿酸）、β-葡聚醣、ω-3 ALA。" }],
