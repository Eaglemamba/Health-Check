  ...
  routineDetail: {
    hourly: {
      ...
      rows: [
        ...
        ["20:15", { en: "Retinol PM 🆕 2026-05-28 (wash face → wait dry → apply)", zh: "Retinol PM 🆕 2026-05-28（洗臉 → 等乾 → 上）" }, "—",
          { en: "CeraVe Resurfacing Retinol 0.1% (encapsulated + ceramide + niacinamide). Pea-sized full face on DRY skin (wait 15-20 min after washing). Start 2-3 nights/week, ramp to nightly by week 5. Sandwich (moisturizer → retinol → moisturizer) if irritation. Do NOT layer same night with BHA/AHA/benzoyl peroxide. Pause ≥1 wk before any laser/peel/microneedling.",
            zh: "CeraVe A 醇 0.1%（包覆型 + ceramide + niacinamide）。豆大量塗乾燥臉部（洗完臉等 15-20 分鐘）。起步每週 2-3 晚，Week 5 漸進至每晚。刺激時用三明治法（保濕 → retinol → 保濕）。同晚不疊 BHA/AHA/benzoyl peroxide。雷射/煥膚/微針前停用 ≥ 1 週。" }],
