    ...
    hourly: {
      ...
      rows: [
        ...
        ["12:00", { en: "Lunch 🆕 2026-06-12 (smoked chicken-breast actual version)", zh: "午餐 🆕 2026-06-12（桃木熏雞胸實際版）" }, { en: "M-F: Soy milk 300mL · Sat-Sun: Low-fat milk 300mL", zh: "週一-五：強化鈣無糖豆漿 300 mL · 週末：低脂奶 300 mL" },
          { en: "ACTUAL 2026-06 lunch (~574 kcal / ~48g protein / ~606mg Na / ~4.3g fiber): steamed sweet potato 150g (130kcal, K 540mg) + 2 BOILED eggs 🆕 (upgraded from tea-eggs, −440mg Na) + unsweetened matcha milk 300mL (190kcal) + peach-wood smoked chicken breast 1 pack 🆕 (label: 113.5kcal / 22.6g protein / 291mg Na — clean low-sodium, moderate purine, UA-safe). NET of two upgrades: tea-egg→boiled-egg saves 440mg Na; edamame→chicken raises protein +13g but LOSES edamame's 7g fiber → refill via breakfast flaxseed + Psyllium 5g×2 (whole-day still ~25–29g). β-glucan barley-oat jar = optional/alternate. NO matcha latte. NO fat-soluble supplements.",
            zh: "實際 2026-06 午餐（~574 kcal / 蛋白 ~48g / 鈉 ~606mg / 纖維 ~4.3g）：蒸地瓜 150g（130kcal、鉀 540mg）+ 水煮蛋 ×2 🆕（由茶葉蛋改良，−440mg 鈉）+ 無糖抹茶牛奶 300mL（190kcal）+ 桃木熏雞胸 1 份 🆕（標示：113.5kcal / 蛋白 22.6g / 鈉 291mg — 乾淨低鈉、嘌呤中等、UA 安全）。兩次改良淨效果：茶葉蛋→水煮蛋省 440mg 鈉；藜麥毛豆→熏雞胸 蛋白 +13g 但丟失毛豆 7g 纖維 → 由早餐亞麻籽 + Psyllium 5g×2 兜底（全日仍 ~25–29g）。大麥燕麥 β-glucan 隔夜罐＝可選/輪替。不放抹茶拿鐵。不放脂溶性補品。" }],
