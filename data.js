...
window.HC_DATA = {
  ...
  hero: {
    ...
    progressMeta: { en: "Day 69 · 67.3 kg · Sat official (5/23)", zh: "第 69 天 · 67.3 公斤 · 週六正式（5/23）" },
    startDate: { en: "Start date · Mar 17, 2026 · Last sync 5/24", zh: "起始日期 · 2026 年 3 月 17 日 · 最後同步 5/24" },
    startWeight: 70,
    targetWeight: 63.1,
    cutPhaseTarget: 65,
  ...
  markers: [
    {
      ...
      delta: { en: "W21 weekly avg (5 days) · target met (<130) · last 113/72 (5/24)", zh: "W21 週均（5 天）· 已達標 (<130) · 最新 113/72 (5/24)" },
  ...
  tracker: {
    ...
    bp: [
      [123,76], [126,74], [131,75], [114,66], [125,70], [122,69], [115,68], [119,76], [119,76], [113,69], [113,69], [113,69], [123,72], [113,72],
    ],
    // daily weight (kg)
    weight: [68, 68.7, 68.5, 68.3, 67.9, 67.3, 67.6, 68.7, 68.6, 68.3, 68, 67.6, 67.3, 67.3],
    // Garmin Sleep Score
    sleep:  [78, 79, 44, 67, 67, 74, 74, 65, 64, 65, 74, 80, 49, 80],
    // Body Battery waking
    bb:     [48, 55, 36, 42, 34, 51, 63, 48, 62, 54, 61, 56, 34, 59],
