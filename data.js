...
window.HC_DATA = {
  ...
  hero: {
    ...
    progressMeta: { en: "Day 56 · 68.0 kg · Sat official (5/9)", zh: "第 56 天 · 68.0 公斤 · 週六正式（5/9）" },
    startDate: { en: "Start date · Mar 17, 2026 · Last sync 5/11", zh: "起始日期 · 2026 年 3 月 17 日 · 最後同步 5/11" },
    startWeight: 70,
    targetWeight: 65,
    currentWeight: 68.0,
  ...
  markers: [
    {
      ...
      delta: { en: "W19 weekly avg (4 days) · target met (<130) · last 126/74 (5/11)", zh: "W19 週均（4 天）· 已達標 (<130) · 最新 126/74 (5/11)" },
    ...
    },
    {
      ...
      val: "68.0", unit: "kg",
      delta: { en: "5/9 Sat official · auto-synced", zh: "5/9 週六正式 · 自動同步" },
  ...
  tracker: {
    ...
    bp: [
      [129,75], [127,75], [127,72], [127,72], [127,72], [127,72], [113,68], [113,68], [113,68], [128,78], [120,73], [131,79], [123,76], [126,74],
    ],
    // 4/21–5/4 daily weight (kg)
    weight: [68.9, 68.4, 68.2, 67.8, 67.9, 67.8, 68.7, 69.1, 68.4, 68.2, 68.2, 68.1, 68, 68.7],
    // Garmin Sleep Score
    sleep:  [64, 69, 64, 71, 52, 69, 77, 77, 71, 75, 68, 78, 78, 79],
    // Body Battery waking
    bb:     [57, 57, 58, 51, 47, 41, 54, 49, 47, 56, 47, 37, 48, 55],
  },
  ...
  suppsDetail: {
    fullStack: {
      ...
      rows: [
        ...
        ["3", "D3K2 ⬆️", "D3 2000 IU + K2 MK-7 180 mcg",
          { en: "Breakfast yogurt blend", zh: "早餐優格飲" }, "250–450"],
        ["4", "Hibiscus calyces", "2g × 2 cups",
          { en: "9:30 + 14:00", zh: "9:30 + 14:00" }, "100–200"],
        ["5", "L-Citrulline ⬆️", "4g (breakfast only)",
          { en: "Breakfast yogurt blend", zh: "早餐優格飲" }, "400–700"],
  ...
  routineDetail: {
    hourly: {
      ...
      rows: [
        ...
        ["7:30–8:00", { en: "Office — yogurt blend", zh: "辦公室 — 優格飲" }, "—",
          { en: "NO matcha. Yogurt + whey 30g + nuts + goji 15–20g + blueberries 80–100g + half banana + raw cacao 5–10g + L-citrulline 4g ⬆️ + D3K2 (D3 2000 IU + K2 MK-7 180mcg ⬆️) + probiotic",
            zh: "不放抹茶。優格 + 乳清 30g + 堅果 + 枸杞 15–20g + 藍莓 80–100g + 香蕉半根 + 生可可粉 5–10g + 瓜胺酸 4g ⬆️ + D3K2（D3 2000 IU + K2 MK-7 180mcg ⬆️）+ 益生菌" }],
        ...
        ["12:00", { en: "Lunch (low-fat)", zh: "午餐（低脂）" }, { en: "Italian matcha latte 400 mL", zh: "義式抹茶拿鐵 400 mL" },
          { en: "Eggs + sweet potato + caesar chicken salad + mushrooms 30–50g 🆕 (king oyster / shimeji — EGT source). Latte = matcha 2–3g + whole milk ~300 mL (must finish by 13:00, caffeine cutoff). NO fat-soluble supplements.",
            zh: "蛋 + 地瓜 + 凱撒雞肉沙拉 + 菇蕈 30-50g 🆕（杏鮑菇/鴻喜菇 — EGT 來源）。拿鐵 = 抹茶 2–3g + 全脂奶 300 mL（13:00 前必須喝完，咖啡因截止）。不放脂溶性補品。" }],
        ...
        ["18:00", { en: "Psyllium dose 2 (30 min pre-dinner)", zh: "Psyllium 第 2 劑（晚餐前 30 分）" }, "240–350 mL",
          { en: "Whole psyllium husk 5g. Dinner moved to 18:30 (was 19:00-20:00) → 3.5 hr buffer before bed (reduces GERD-OSA risk 7.5×, Iwakura 2009).",
            zh: "全粒 5g。晚餐提前至 18:30（從 19:00-20:00），與 22:00 熄燈間隔 3.5 hr → 防 GERD-OSA（Iwakura 2009 風險降 7.5×）。" }],
        ["18:30", { en: "Dinner (low-Na UberEats)", zh: "晚餐（低鈉 UberEats）" }, { en: "sips only", zh: "僅小啜" },
          { en: "Avoid hotpot/grilled/Sichuan/processed. Prefer steamed fish + mushrooms 50-80g 🆕 (oyster/shimeji — EGT) / sushi / lean chicken + mushroom salad. After dinner 18:30: Fish oil ×2 (first half).",
            zh: "避火鍋/燒肉/川湘/加工肉。偏好清蒸魚 + 秀珍菇/鴻喜菇 50-80g 🆕（EGT）/握壽司/白肉雞 + 菇蕈沙拉。晚餐後 18:30：魚油 ×2（前半）。" }],
        ...
        ["20:00", { en: "Wind-down + liquid cutoff 🆕", zh: "Wind-down + 液體截止 🆕" }, "—",
          { en: "Indoor lights < 50 lux (warm yellow, main lights off). Screen blue-light filter on. NO more liquids (prevent nocturia disrupting REM). BP measurement #2 if not done.",
            zh: "室內燈光降至 < 50 lux（暖黃色，關主燈）。螢幕藍光濾鏡開啟。不再喝任何液體（防夜尿打斷 REM）。BP 第 2 次測量（若未量）。" }],
        ...
        ["21:00", { en: "Bedtime stack (tri-axis sleep onset)", zh: "睡前 stack（三軸入睡）" }, "—",
          { en: "Mg glycinate 400mg (GABA brake) + Tart cherry 1000-2000mg (melatonin axis) + Glycine pure powder 3g 🆕 (SCN core-temp drop + NMDA + brainstem). Mouth tape + humidifier 50-60% RH + AC ≥26°C + saline rinse (OSA bridge).",
            zh: "鎂甘胺酸 400mg（GABA 煞車）+ 酸櫻桃 1000-2000mg（melatonin 軸）+ Glycine 純粉 3g 🆕（SCN 核心降溫 + NMDA + 腦幹 三軸）。嘴封 + 加濕器 50-60% RH + 冷氣 ≥26°C + 鹽水洗鼻（OSA 橋接）。" }],
        ["21:30", { en: "In bed (paper book / Kindle warm light only)", zh: "上床（紙本書 / Kindle 暖光）" }, "—",
          { en: "Side sleep + back pillow (POSA position therapy). No phone.",
            zh: "側睡 + 背後枕頭（POSA 體位治療）。不滑手機。" }],
    ...
    summary: {
      ...
      items: {
        en: [
          "Yogurt blend (06:00): whey 30g + goji 15–20g + blueberries 80–100g + cacao 5–10g + L-citrulline 4g ⬆️ + D3K2 (D3 2000 IU + K2 MK-7 180mcg ⬆️) + probiotic",
          "Hibiscus tea: 2g × 2 cups (06:30 + 14:00), 240 mL each, 5–10 min steep",
          "Psyllium husk: 5g × 2 (11:30 + 18:00), each in 240–350 mL water — week 1 ramp 5g × 1, week 2+ at 5g × 2",
          "Lunch (12:00) matcha latte: matcha 2–3g + whole milk 300 mL — EGCG ~48–95 mg (caffeine cutoff 13:00)",
        ...
        zh: [
          "優格飲（06:00）：乳清 30g + 枸杞 15–20g + 藍莓 80–100g + 可可 5–10g + 瓜胺酸 4g ⬆️ + D3K2（D3 2000 IU + K2 MK-7 180mcg ⬆️）+ 益生菌",
          "洛神花茶：2g × 2 杯（06:30 + 14:00），各 240 mL，沖 5–10 分鐘",
          "Psyllium husk：5g × 2（11:30 + 18:00），各配 240–350 mL — 第 1 週 5g × 1 起步、第 2 週起 5g × 2",
          "午餐（12:00）抹茶拿鐵：抹茶 2–3g + 全脂奶 300 mL — EGCG ~48–95 mg（咖啡因截止 13:00）",
          "南瓜籽（15:30）：30g 下午點心",
