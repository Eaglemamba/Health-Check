...
window.HC_DATA = {
  ...
  hero: {
    ...
    progressMeta: { en: "Day 57 · 68.0 kg · Sat official (5/9)", zh: "第 57 天 · 68.0 公斤 · 週六正式（5/9）" },
    startDate: { en: "Start date · Mar 17, 2026 · Last sync 5/12", zh: "起始日期 · 2026 年 3 月 17 日 · 最後同步 5/12" },
    startWeight: 70,
    targetWeight: 65,
    currentWeight: 68.0,
  ...
  markers: [
    {
      ...
      delta: { en: "W19 weekly avg (4 days) · target met (<130) · last 131/75 (5/12)", zh: "W19 週均（4 天）· 已達標 (<130) · 最新 131/75 (5/12)" },
  ...
  tracker: {
    ...
    bp: [
      [127,75], [127,72], [127,72], [127,72], [127,72], [113,68], [113,68], [113,68], [128,78], [120,73], [131,79], [123,76], [126,74], [131,75],
    ],
    // 4/21–5/4 daily weight (kg)
    weight: [68.4, 68.2, 67.8, 67.9, 67.8, 68.7, 69.1, 68.4, 68.2, 68.2, 68.1, 68, 68.7, 68.5],
    // Garmin Sleep Score
    sleep:  [69, 64, 71, 52, 69, 77, 77, 71, 75, 68, 78, 78, 79, 44],
    // Body Battery waking
    bb:     [57, 58, 51, 47, 41, 54, 49, 47, 56, 47, 37, 48, 55, 36],
  },
