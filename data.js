  ...
  diet: {
    ...
    beverage: {
      ...
      head: { en: ["Time", "Drink", "Metabolic target"],
              zh: ["時間", "飲料", "代謝目標"] },
      rows: [
        [{ en: "Breakfast 07:00", zh: "早餐 07:00" },
          { en: "Yogurt 150cc + low-fat milk 100cc + ON whey + cacao + L-citrulline 4g + chia 5g", zh: "優格 150cc + 低脂奶 100cc + ON 乳清 + 可可 + 瓜胺酸 4g + 奇亞籽 5g" },
          { en: "Casein+whey (UA clearance) + cocoa flavanols + NO precursor + ω-3 ALA", zh: "酪蛋白+乳清（尿酸排泄）+ 可可 flavanols + NO 前體 + ω-3 ALA" }],
