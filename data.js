...
window.HC_DATA = {
  ...
  suppsDetail: {
    fullStack: {
      ...
      rows: [
        ...
        ["10", "CoQ10 ubiquinone 🆕 2026-06-08", "100–200 mg (confirm)",
          { en: "Self-started 2026-06-08. Take at BREAKFAST with fat-soluble cluster (D3/K2) — fat-soluble, needs ~12g meal fat (flaxseed+yogurt OK); morning avoids sleep interference. Ubiquinone (oxidized) absorbs less than ubiquinol → fat pairing essential. LVH/mito support (Q-SYMBIO MACE −43% in HF stage B). Confirm your actual mg dose.", zh: "2026-06-08 自行啟動。**早餐**與脂溶性群組（D3/K2）同服 — 脂溶性，需 ~12g 餐脂（亞麻籽+優格足）；早上避免干擾睡眠。Ubiquinone（氧化型）吸收低於 ubiquinol → 必配脂肪。LVH/粒線體支持（Q-SYMBIO 心衰 stage B MACE −43%）。請確認實際 mg 劑量。" }, "600–1,000"],
  ...
  routineDetail: {
    hourly: {
      ...
      rows: [
        ...
        ["7:00", { en: "Breakfast (home) — yogurt blend 🆕 2026-06-01 v4 (+ baby kale)", zh: "早餐（家）— 優格飲 🆕 2026-06-01 v4（新增嫩 kale）" }, "—",
          { en: "Snow Factory No.6 yogurt 150g + NOW Sports WPI 30g + blueberries 150g + ground flaxseed 15g + baby kale 15–20g 🆕 + L-citrulline 4g + creatine monohydrate 5g 🆕 2026-06-07 + CoQ10 (ubiquinone) 🆕 2026-06-08 + D3 3000 IU + K2 MK-7 180mcg + probiotic + almond milk 100mL + lemon juice 1 tsp (optional). NO matcha (relocated to office 9:30). CoQ10 co-located with the fat-soluble cluster (D3/K2) — flaxseed+yogurt ~12g fat enables absorption; morning timing avoids any sleep interference. Casein+whey (UA clearance) + anthocyanin RCT dose + ALA ω-3 + lignans + sulforaphane / lutein / K1 / nitrates.",
            zh: "雪坊 6 號優格 150g + NOW Sports WPI 30g + 藍莓 150g + 亞麻籽粉 15g + 嫩 kale 15-20g 🆕 + 瓜胺酸 4g + 肌酸 5g 🆕 2026-06-07 + CoQ10（ubiquinone）🆕 2026-06-08 + D3 3000 IU + K2 MK-7 180mcg + 益生菌 + 杏仁奶 100mL + 檸檬汁 1 茶匙（可選）。CoQ10 與脂溶性群組（D3/K2）同放 — 亞麻籽+優格 ~12g 脂肪助吸收；早上服避免干擾睡眠。酪蛋白+乳清（尿酸排泄）+ 花青素 RCT 劑量 + ALA ω-3 + lignans + sulforaphane / 葉黃素 / K1 / 硝酸鹽。" }],
    ...
    summary: {
      ...
      items: {
        en: [
          "Yogurt blend (06:00) 🆕 2026-06-01 v4: NOW Sports WPI 30g + yogurt 150g + blueberries 150g + ground flaxseed 15g + baby kale 15–20g 🆕 + L-citrulline 4g (+2g pre-workout on training days) + creatine monohydrate 5g 🆕 2026-06-07 + CoQ10 ubiquinone 🆕 2026-06-08 (with fat-soluble cluster) + D3 3000 IU + K2 MK-7 180mcg + probiotic + almond milk 100mL + lemon juice 1 tsp (optional). NO nuts / NO cocoa / NO oats in blend (flaxseed covers ω-3 ALA; β-glucan now covered at lunch by Quaker barley-oat 40g).",
        ...
        zh: [
          "優格飲（06:00）🆕 2026-06-01 v4：NOW Sports WPI 30g + 雪坊優格 150g + 藍莓 150g + 亞麻籽粉 15g + 嫩 kale 15-20g 🆕 + 瓜胺酸 4g（訓練日訓前再 +2g）+ 肌酸 5g 🆕 2026-06-07 + CoQ10 ubiquinone 🆕 2026-06-08（與脂溶性群組同放）+ D3 3000 IU + K2 MK-7 180mcg + 益生菌 + 杏仁奶 100mL + 檸檬汁 1 茶匙（可選）。**不含堅果、不含可可、不含燕麥**（亞麻籽補 ω-3 ALA；β-glucan 由午餐 Quaker 大麥燕麥 40g 補）",
