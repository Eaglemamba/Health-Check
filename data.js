...
window.HC_DATA = {
  ...
  hero: {
    ...
    progressMeta: { en: "Day 105 · 66.2 kg · Sat official (6/6)", zh: "第 105 天 · 66.2 公斤 · 週六正式（6/6）" },
    startDate: { en: "Start date · Mar 17, 2026 · Last sync 6/29", zh: "起始日期 · 2026 年 3 月 17 日 · 最後同步 6/29" },
    startWeight: 70,
    targetWeight: 65,
    currentWeight: 66.2,
    ...
    phases: {
      ...
      items: [
        ...
        { ph: "2", range: { en: "Recomp · since 2026-06-08", zh: "Recomp · 2026-06-08 起" }, vol: "Resistance 2×/wk primary",
          body: { en: "Resistance training is now PRIMARY (muscle gain + fat loss). 2×/week full-body: Day A squat/push, Day B hinge/pull, each ~60 min, RIR 1–2, 8–15 reps, progressive overload (double progression), free-weight or machine. Aerobic demoted to maintenance: incline Z2 walk 20 min after sessions. Protein ~130 g/day + creatine 5 g. Full menu in articles/. Sleep is the rate-limiter — hold at 2×/week until PSG (6/21) improves recovery.",
                  zh: "阻力訓練升為主項（增肌減脂）。每週 2 次全身：Day A 蹲/推、Day B 鉸鏈/拉，各 ~60 分，RIR 1–2、8–15 下、漸進超負荷（double progression），自由重量或機械皆可。有氧降為維持：課後斜坡 Z2 走 20 分。蛋白 ~130 g/天 + 肌酸 5 g。完整菜單見 articles/。睡眠為限速因子 — 維持 2 次/週，待 6/21 PSG 改善恢復後再加。" } },
        { ph: "3", range: { en: "Recomp+ · after sleep fixed", zh: "Recomp+ · 睡眠修復後" }, vol: "Resistance 3×/wk",
          body: { en: "After OSA/sleep improves: optionally add a 3rd resistance session or push volume toward ~10 sets/muscle/week. Advance loads first (double progression), then frequency. Keep incline Z2 for cardiovascular + VAT. Re-assess via DXA every 8–12 weeks.",
                  zh: "OSA / 睡眠改善後：可加第 3 次重訓或把量推向每肌群 ~10 組/週。先進負荷（double progression）再加頻率。保留斜坡 Z2 顧心血管 + 內臟脂肪。每 8–12 週 DXA 複評。" } },
      ],
    },
  },
  ...
  tracker: {
    ...
    bp: [
      [121,75], [120,71], [129,72], [122,71], [119,74], [119,74], [128,78], [128,78], [128,78], [122,75], [122,75], [122,75], [122,75], [122,75],
    ],
    // daily weight (kg)
    weight: [67.2, 66.8, 66.9, 66.7, 66.3, 66.5, 66.4, 66.5, 66.5, 66.5, 67.5, 67.2, 66.9, 67.3],
    // Garmin Sleep Score
    sleep:  [67, 81, 70, 59, 55, 78, 51, 61, 81, 73, 76, 74, 78, 54],
    // Body Battery waking
    bb:     [29, 41, 56, 37, 32, 54, 22, 27, 32, 35, 37, 40, 48, 45],
    ...
    spo2Nadir: [null, 90, 87, 87, 91, 88, null, 88, 86, 85, 94, 81, 93, 87],
  },
  ...
  suppsDetail: {
    fullStack: {
      ...
      rows: [
        ...
        ["—", "Pumpkin seeds + Walnuts 🆕 2026-06-10 (food)", "Pumpkin 15g + walnut 15–20g (4–5)",
          { en: "Afternoon 15:30. Walnuts → LDL (WAHA/PREDIMED RCT); pumpkin halved to cap ~200 kcal", zh: "下午 15:30。核桃 → 降 LDL（WAHA/PREDIMED RCT）；南瓜籽減半控 ~200 kcal" }, "400–600"],
  ...
  routineDetail: {
    hourly: {
      ...
      rows: [
        ...
        ["12:00", { en: "Lunch 🆕 2026-06-12 (smoked chicken-breast actual version)", zh: "午餐 🆕 2026-06-12（桃木熏雞胸實際版）" }, { en: "M-F: Soy milk 300mL · Sat-Sun: Low-fat milk 300mL", zh: "週一-五：強化鈣無糖豆漿 300 mL · 週末：低脂奶 300 mL" },
          { en: "ACTUAL 2026-06 lunch (~574 kcal / ~48g protein / ~606mg Na / ~4.3g fiber): steamed sweet potato 150g (130kcal, K 540mg) + 2 BOILED eggs 🆕 (upgraded from tea-eggs, −440mg Na) + unsweetened matcha milk 300mL (190kcal) + peach-wood smoked chicken breast 1 pack 🆕 (label: 113.5kcal / 22.6g protein / 291mg Na — clean low-sodium, moderate purine, UA-safe). NET of two upgrades: tea-egg→boiled-egg saves 440mg Na; edamame→chicken raises protein +13g but LOSES edamame's 7g fiber → refill via breakfast flaxseed + Psyllium 5g×2 (whole-day still ~25–29g). β-glucan barley-oat jar = optional/alternate. NO matcha latte. NO fat-soluble supplements. 🆕 EAT-OUT ROTATION (for vegetable diversity, the one gap): doki poke — quinoa rice HALF + 鹽味 sous-vide CHICKEN (low-purine; NOT seafood/squid/shrimp/roe/cheese-beef/sukiyaki) + 5 veg (leafy/broccoli/mixed-mushroom/purple-cabbage/black-fungus) + fruit-yogurt sauce ON THE SIDE + shichimi + sesame. See articles/diet-nutrition/2026-06-12-poke-bowl-ordering-guide.md.",
            zh: "實際 2026-06 午餐（~574 kcal / 蛋白 ~48g / 鈉 ~606mg / 纖維 ~4.3g）：蒸地瓜 150g（130kcal、鉀 540mg）+ 水煮蛋 ×2 🆕（由茶葉蛋改良，−440mg 鈉）+ 無糖抹茶牛奶 300mL（190kcal）+ 桃木熏雞胸 1 份 🆕（標示：113.5kcal / 蛋白 22.6g / 鈉 291mg — 乾淨低鈉、嘌呤中等、UA 安全）。兩次改良淨效果：茶葉蛋→水煮蛋省 440mg 鈉；藜麥毛豆→熏雞胸 蛋白 +13g 但丟失毛豆 7g 纖維 → 由早餐亞麻籽 + Psyllium 5g×2 兜底（全日仍 ~25–29g）。大麥燕麥 β-glucan 隔夜罐＝可選/輪替。不放抹茶拿鐵。不放脂溶性補品。🆕 外食輪替（補蔬菜多樣性這唯一缺口）：doki poke — 藜麥飯**半份** + **鹽味舒肥雞**（低嘌呤；勿選海鮮/魷/蝦/魚卵/起司牛/壽喜燒）+ 5 蔬菜（綠葉/青花/綜合菌菇/紫高麗/黑木耳）+ 水果優格醬**另外放** + 七味粉 + 白芝麻。詳見 articles/diet-nutrition/2026-06-12-poke-bowl-ordering-guide.md。" }],
        ...
        ["15:00–16:00", { en: "Afternoon snack", zh: "下午點心" }, { en: "as needed", zh: "視口渴" },
          { en: "Pumpkin seeds 15g + walnuts 15–20g (4–5 kernels) 🆕 2026-06-10, raw/unsalted. Walnut ALA ω-3 + polyphenols → LDL (WAHA RCT LDL −8.5%; PREDIMED CV events −30% w/ mixed nuts). Pumpkin halved → total snack ~200 kcal (protects 65kg goal). Zn ~4mg + Mg ~75mg + tryptophan retained. NO 72% chocolate stacking.",
            zh: "南瓜籽 15g + 核桃 15–20g（4–5 顆）🆕 2026-06-10，生/無鹽。核桃 ALA ω-3 + 多酚 → 降 LDL（WAHA RCT LDL −8.5%；PREDIMED 綜合堅果心血管事件 −30%）。南瓜籽減半 → 點心總熱量 ~200 kcal（顧 65kg 目標）。保留鋅 ~4mg + 鎂 ~75mg + 色胺酸。72% 巧克力不堆疊。" }],
        ...
        ["17:00", { en: "Psyllium dose 2 (office) 🆕 2026-05-14 · milk 2026-06-10", zh: "Psyllium 第 2 劑（辦公室）🆕 2026-05-14 · 改配奶 2026-06-10" }, "300 mL low-fat milk",
          { en: "Psyllium 5g + 300 mL low-fat milk at office before leaving (5pm). Milk = the required gelling fluid; low-fat (not whole) keeps sat-fat off the LDL goal. Drink fast — gels quicker in milk. ≥1 hr from adsorption-sensitive supplements. Peak satiety 18:30-19:00 (1.5-2 hr) buffers HSR commute → dinner.",
            zh: "下班前（5 點）在辦公室服 Psyllium 5g + 低脂牛奶 300 mL。牛奶即為膨脹所需液體；用低脂（非全脂）避免飽和脂肪牴觸 LDL 目標。沖好快喝（牛奶中膠化更快）。距會被吸附的補品 ≥1 小時。1.5-2 小時後（18:30-19:00）達飽足峰值，緩衝高鐵 → 晚餐窗。" }],
        ["17:30", { en: "Green smoothie 🆕 2026-06-12 (alternates with 18:00 egg+banana — pick ONE)", zh: "綠拿鐵 🆕 2026-06-12（與 18:00 蛋+香蕉擇一輪替）" }, { en: "= the drink itself ~300mL", zh: "= 飲品本身 ~300mL" },
          { en: "~240 kcal / ~12.5g protein / ~6.5g fiber. Pre-dinner preload (blunts dinner appetite + post-meal glucose) AND vegetable delivery. Default Version B (UA-focus): low-fat milk 300mL + baby kale 40g + banana 50g + kiwi 60g + lemon juice. Version A (LDL-focus): unsweetened soy milk 300mL + kale 40g + banana 100g + blueberry 50g. RULES: (1) MUST replace the banana+milk/egg snack, not add on top → net-calorie-neutral; (2) 3–4×/week — on non-green days take the 18:00 egg+banana OR 15:00 nuts instead (alternate, don't stack — both ~220–240 kcal would crush dinner to ~290 kcal). Kale 40g does NOT replace dinner vegetables. Make at home (blend with AM yogurt drink), bottle, drink at office. See articles/diet-nutrition/2026-06-12-green-smoothie-rct-review.md.",
            zh: "~240 kcal / 蛋白 ~12.5g / 纖維 ~6.5g。晚餐 preload（壓晚餐食慾 + 餐後血糖）兼蔬菜載體。預設版本 B（顧 UA）：低脂奶 300mL + 嫩 kale 40g + 香蕉 50g + 奇異果 60g + 檸檬汁。版本 A（顧 LDL）：無糖豆漿 300mL + kale 40g + 香蕉 100g + 藍莓 50g。鐵律：(1) 必須**取代**香蕉+牛奶/蛋香蕉點心，非外加 → 淨熱量中性；(2) 3–4 次/週 — 未喝日改吃 18:00 蛋+香蕉**或** 15:00 堅果（輪替不堆疊；兩者各 ~220–240 kcal 並存會把晚餐壓到 ~290 kcal）。kale 40g 不取代晚餐蔬菜。在家打（與晨間優格飲同打）裝瓶帶辦公室喝。詳見 articles/diet-nutrition/2026-06-12-green-smoothie-rct-review.md。" }],
        ["18:00", { en: "HSR snack 🆕 2026-05-14 (alternates with 17:30 green smoothie — pick ONE)", zh: "高鐵點心 🆕 2026-05-14（與 17:30 綠拿鐵擇一輪替）" }, "—",
          { en: "1 boiled egg + half banana (7g protein + 210mg K). Protein suppresses ghrelin → prevents bento rice overeating at dinner. On green-smoothie days, SKIP this (already had the 17:30 preload).",
            zh: "水煮蛋 1 顆 + 半根香蕉（7g 蛋白 + 鉀 210mg）。蛋白抑制 ghrelin → 防 19:00 便當紫米爆食。喝綠拿鐵的日子**跳過此格**（17:30 已有 preload）。" }],
    ...
    summary: {
      ...
      items: {
        en: [
          ...
          "Psyllium husk: 5g × 2 (11:30 + 17:00) 🆕 2026-05-14, 11:30 in 300 mL water + 17:00 in 300 mL low-fat milk 🆕 2026-06-10 (office, before leaving); peak satiety 18:30–19:00",
          ...
          "Afternoon snack (15:30) 🆕 2026-06-10: Pumpkin seeds 15g + walnuts 15–20g (4–5 kernels) — walnut ALA/polyphenols → LDL (WAHA/PREDIMED RCT); pumpkin halved to cap ~200 kcal",
        ...
        zh: [
          ...
          "Psyllium husk：5g × 2（11:30 + 17:00）🆕 2026-05-14，11:30 配 300 mL 水 + 17:00 配低脂牛奶 300 mL 🆕 2026-06-10（辦公室下班前）；18:30-19:00 達飽足感峰值",
          ...
          "下午點心（15:30）🆕 2026-06-10：南瓜籽 15g + 核桃 15–20g（4–5 顆）— 核桃 ALA/多酚 → 降 LDL（WAHA/PREDIMED RCT）；南瓜籽減半控 ~200 kcal",
  ...
  safetyDetail: {
    triadPriority: {
      ttl: { en: "LVH + UA 8.9 + lipids — multi-factor priority (OSA removed 6/29)", zh: "LVH + 尿酸 8.9 + 血脂 — 多因子優先處置（OSA 已移除 6/29）" },
      intro: { en: "⚠️ REVISED 2026-06-29: OSA dropped from this triad — fingertip oximetry ruled out hypoxia. LVH/BP re-attributed to BP load + genetics (not nightly desat). UA 8.9 now handled as constitutional (no longer waiting on OSA). Order is by leverage on cardiovascular outcome; cardiac imaging stays #1.",
               zh: "⚠️ 2026-06-29 修訂：OSA 已自三因子移除 — 指尖血氧排除缺氧。LVH/BP 重新歸因為 BP 負荷 + 基因（非夜間 desat）。尿酸 8.9 改為體質性處理（不再等 OSA）。以心血管預後槓桿排序；心臟影像仍為第一。" },
      ...
      rows: [
        ...
        ["2",
          { en: "Behavioral sleep repair (OSA/PSG path retired 6/29)", zh: "行為性睡眠修復（OSA/PSG 路徑 6/29 退役）" },
          { en: "Fingertip oximetry flat → no hypoxia, no OSA-driven myocardial injury. Light sleep re-attributed to nighttime arousal (stock-watching) + autonomic. Action: decouple stock-watching, CBT-I/stimulus control, HRV resonance breathing, Mg/glycine. Full PSG (EEG+EMG) only if still poor after behavioral trial (to rule out UARS/PLMD).",
            zh: "指尖血氧平 → 無缺氧、無 OSA 驅動心肌傷害。淺眠重新歸因為夜間喚醒（看盤）+ 自律神經。動作：看盤脫鉤、CBT-I/stimulus control、HRV 共振呼吸、鎂/glycine。僅在行為調整後仍差才做含 EEG+EMG 全套 PSG（排 UARS/PLMD）。" }],
        ["3",
    ...
    osaCardiacMap: {
      ...
      intro: {
        en: "⚠️ RETRACTED 2026-06-29 — kept for audit trail only. This entire OSA→cardiac causal chain was built on Garmin wrist SpO2, which fingertip transmittance oximetry has since shown to be motion artifact (flat all-night SpO2, no desaturation). The T90/desat inputs (incl. the 5/17 'natural experiment') are invalid. LVH/BP/UA are re-attributed to BP load + genetics + constitution, NOT nightly hypoxia. Do not treat this table as current. See articles/osa-sleep/2026-06-29-spo2-fingertip-oximetry-correction.md.",
        zh: "⚠️ 2026-06-29 已撤回 — 僅留存查。整條 OSA→心臟因果鏈建立在 Garmin 腕式 SpO2 上，已由指尖透射式血氧證實為動作 artifact（整夜平穩、無掉氧）。其 T90/desat 輸入（含 5/17「自然實驗」）皆失效。LVH/BP/UA 重新歸因為 BP 負荷 + 基因 + 體質，非夜間缺氧。本表非現行結論。詳見 articles/osa-sleep/2026-06-29-spo2-fingertip-oximetry-correction.md。",
      },
    ...
    osaReversibility: {
      ...
      intro: {
        en: "⚠️ RETRACTED 2026-06-29 — kept for audit trail only. This 'OSA damage / recovery' timeline assumed chronic nocturnal hypoxia that fingertip oximetry has since ruled out (flat all-night SpO2). There is no demonstrated OSA-driven damage to reverse. Cardiac findings (LVH / atrial / plaque risk) remain real but are re-attributed to BP load + lipids + genetics and handled via echo/Holter — not via OSA treatment. Do not treat this table as current. See articles/osa-sleep/2026-06-29-spo2-fingertip-oximetry-correction.md.",
        zh: "⚠️ 2026-06-29 已撤回 — 僅留存查。本「OSA 損傷／修復」時間軸假設慢性夜間缺氧，已由指尖血氧排除（整夜平穩）。並無已證實的 OSA 驅動損傷可逆轉。心臟發現（LVH／心房／斑塊風險）仍為真，但重新歸因為 BP 負荷 + 血脂 + 基因，循 echo/Holter 處理，非靠 OSA 治療。本表非現行結論。詳見 articles/osa-sleep/2026-06-29-spo2-fingertip-oximetry-correction.md。",
      },
  ...
  osa: {
    intro: {
      en: "⚠️ RETRACTED 2026-06-29 — kept for audit trail only. The 'escalating SpO2 desaturation' that triggered this POSA trial was Garmin wrist artifact; fingertip transmittance oximetry later showed a flat all-night SpO2 with no desaturation. The POSA trial and its CPAP-equivalent claims no longer apply. See articles/osa-sleep/2026-06-29-spo2-fingertip-oximetry-correction.md.",
      zh: "⚠️ 2026-06-29 已撤回 — 僅留存查。觸發此 POSA 試驗的「SpO2 desat 升級」為 Garmin 腕式 artifact；指尖透射式血氧後證實整夜平穩、無掉氧。POSA 試驗與其「等同 CPAP」宣稱不再適用。詳見 articles/osa-sleep/2026-06-29-spo2-fingertip-oximetry-correction.md。",
    },
    intervention: {
