    ...
    hourly: {
      ...
      rows: [
        ...
        ["17:00", { en: "Resistance training / Zone-2 walk (fixed window) 🆕", zh: "阻力訓練 / Zone-2 走路（固定時段）🆕" }, "—",
          { en: "30 min. RT 2×/week (squat/deadlift/push/pull); Zone-2 walk 3×/week (HR 109-127 bpm). Hydration deadline 2.5 L before this window closes. Pre-workout half banana; post-workout whey 25-30g within 30 min.",
            zh: "30 min。重訓 2×/週（深蹲/硬舉/推/拉）；Zone-2 走路 3×/週（心率 109-127 bpm）。本時段結束前飲水達 2.5 L 截止。訓前半根香蕉；訓後 30 min 內補 whey 25-30g。" }],
