...
![VO2max 8-Year Trend](garmin-full-charts/01_vo2max.png)

### Fitness Age Gap

![Fitness Age Gap](garmin-full-charts/02_fitness_age.png)

### Resting Heart Rate

![Resting Heart Rate](garmin-full-charts/03_rhr.png)

### Weight Trend

![Weight Trend](garmin-full-charts/04_weight.png)

### Steps & Intensity Minutes

![Steps & Intensity Minutes](garmin-full-charts/05_steps_intensity.png)

### Stress & Body Battery

![Stress & Body Battery](garmin-full-charts/06_stress_bb.png)

### Abnormal HR Events

![Abnormal HR Events](garmin-full-charts/07_abnormal_hr.png)

### Activities by Year/Type

![Activities by Year/Type](garmin-full-charts/08_activities.png)
