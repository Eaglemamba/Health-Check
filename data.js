...
window.HC_DATA = {
  ...
  suppsDetail: {
    ...
    citrulline: {
      ...
      points: {
        en: [
          "Directly opposes LVH progression. NO is anti-hypertrophic via BP reduction + RAAS/SNS modulation [Samy PMC6164974]. In LVH animal models, eNOS dropped 35%; L-arginine 5 weeks → eNOS +27%, hypertrophy index −53% [Aminuddin 2016].",
          "Improves diastolic function. Coronary microvascular NO selectively enhances myocardial relaxation — impaired in LVH [Paulus, Circulation 2000].",
          "Reduces arterial stiffness independent of BP. Citrulline may improve elasticity more than BP numbers [PMC11053694].",
        ...
        zh: [
          "直接對抗 LVH 進展。NO 透過降 BP + RAAS/SNS 調節抗肥厚 [Samy PMC6164974]。LVH 動物模型 eNOS 下降 35%；L-精胺酸 5 週 → eNOS +27%、心肌肥厚指數 −53% [Aminuddin 2016]。",
          "改善心臟舒張功能。冠脈微血管 NO 選擇性增強心肌放鬆 — 在 LVH 中受損 [Paulus, Circulation 2000]。",
          "降低動脈僵硬度（獨立於 BP）。瓜胺酸對動脈彈性的改善可能超過降 BP 數字 [PMC11053694]。",
      ...
      bp: { en: "Luo 2025 meta (15 RCTs, 415 participants): SBP −4.02 mmHg (P=0.002), DBP −2.54 mmHg (P=0.004) in middle-aged/older adults. Citrulline + arginine combo: SBP −10.44 mmHg [PMID: 40789388]. Significant DBP only at ≥6g/day [PMID: 30788274].",
            zh: "Luo 2025 meta（15 項 RCT、415 人）：中老年 SBP −4.02 mmHg（P=0.002）、DBP −2.54 mmHg（P=0.004）。瓜胺酸 + 精胺酸組合：SBP −10.44 mmHg [PMID: 40789388]。DBP 顯著降低僅 ≥6g/日 [PMID: 30788274]。" },
