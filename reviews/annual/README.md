...
| `2024-12-05` 獨立報告 | ✅ 補檔完成 (2026-05-23) | 已建 `2024-12-05.md` + `2024-12-05-pe.json`；資料來源為 `2025/2025.md` 前次欄 + 使用者 2024 lifestyle 口述補錄（168 IF + 1-2×/週室內超慢跑）|
...
| 2026-05-23 | 補檔 `2024-12-05.md` + `2024-12-05-pe.json`（資料源自 2025/2025.md 前次欄 + lifestyle context 口述補錄）|
